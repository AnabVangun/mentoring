...
import mentoring.datastructure.SetPropertyDescriptionTest.SetPropertyArgs;
import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.DynamicNode;
import org.junit.jupiter.api.TestFactory;

class SetPropertyDescriptionTest extends MultiplePropertyDescriptionTest<SetPropertyArgs> {
    @Override
    ...
    static class SetPropertyArgs extends MultiplePropertyDescriptionArgs{
        ...
        @Override
        protected SetPropertyDescription<?> convert() {
            return new SetPropertyDescription<>(getExpectedName(), getExpectedHeaderName(), 
                    expectedType);
        }
    }
}
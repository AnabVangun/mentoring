 ...
 */
public class IndexedPropertyDescription<K> extends MultiplePropertyDescription<K,Integer> {
    
    /**
     * Initialise a new IndexedPropertyDescription.
     ...
     */
    public IndexedPropertyDescription(String name, String headerName, PropertyType<K> keyType) {
    ...
    @Override
    public IndexedPropertyDescription<K> withHeaderName(String headerName) {
        return new IndexedPropertyDescription<>(getName(), headerName, getType());
    }
    ...
    public boolean equals(Object o){
        return o instanceof IndexedPropertyDescription cast && attributeEquals(cast);
    }

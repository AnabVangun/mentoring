 ...
 */
public abstract class MultiplePropertyDescription<K,V> extends PropertyDescription<K>{
    private final PropertyType<V> valueType;
    
    /**
     * Initialises a new MultiplePropertyDescription.
     ...
     */
    MultiplePropertyDescription(String name, String headerName, PropertyType<K> keyType,

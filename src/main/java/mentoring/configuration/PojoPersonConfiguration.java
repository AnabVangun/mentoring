...
public enum PojoPersonConfiguration{
    ...
    MENTEE_CONFIGURATION_2024_DATA(new PersonConfiguration("Mentee configuration for 2024 data",
            Set.of(new PropertyName<>("Email", "email", PropertyType.STRING),
                    new PropertyName<>("Portable", "Portable", PropertyType.STRING),
                    new PropertyName<>("Promotion", "Promotion et cycle (normalement X22)", 
                            PropertyType.YEAR),
                    new PropertyName<>("Maturité", 
                            "Quel est le degré de maturité de ton projet académique et professionnel actuel ?", 
                            PropertyType.INTEGER),
                    new PropertyName<>("Explication de maturité", "Peux-tu expliquer ta réponse ?",
                            PropertyType.STRING),
